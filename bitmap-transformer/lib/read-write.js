...
let readW = module.exports = {};

readW.read = (filePath, outputPath, transform, targetColor, callback) => {
  return fs.readFile(filePath, (err, data) =>{
    if(err){throw err;}
    let bitmapHeader = data.slce(0, 13);
    ...
    transform(image.colorTable, targetColor);
